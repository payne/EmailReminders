...
@Table(name = "magic_link_tokens", indexes = {
    ...
    @Index(name = "idx_magic_link_user", columnList = "user_id")
})
...
public class MagicLinkToken {
    ...
    public MagicLinkToken(String token, User user, LocalDateTime expiresAt) {
        this.token = token;
        this.user = user;
    ...
    public boolean equals(Object o) {
        ...
        MagicLinkToken that = (MagicLinkToken) o;
